...
namespace Line.Messaging
{
    ...
    public class LineMessagingClient : ILineMessagingClient, IDisposable
    {
        ...
        {
            var response = await ReplyMessageWithResponseAsync(replyToken, messages).ConfigureAwait(false);
        ...
        /// <param name="replyToken">ReplyToken</param>
        /// <param name="messages">Reply messages. Up to 5 messages.</param>
        public virtual async Task<HttpResponseMessage> ReplyMessageWithResponseAsync(string replyToken, IList<ISendMessage> messages)
        {
